...
- Currently an RSE at Princeton University

- Did my PhD in Physics (specifically, string theory)

[comment]: # (||| data-auto-animate)

## Quick self-introduction

- Now working on High-Energy Experimental Physics
  - Line-Segment Tracking: particle track reconstruction on GPUs
  - Scikit-HEP: developing Uproot, a Python IO library for ROOT files
  - Developed and/or maintain the CI/CD workflows for these projects
...
https://github.com/ariostas-talks/2026-03-24-cicd
